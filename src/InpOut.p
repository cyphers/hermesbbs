...
interface
	...
	uses
		AppleTalk, ADSP, Serial, Sound, SANE, serialnums, Initial, User, terminal, Message_Editor, SystemPrefs, nodeprefs, inpOut2;
...
{$IFC COPYPROTECT}
			...
			begin
				...
				if (templong - intSystRec.startDate > 2800000) or ((tempLong - myUsers^^[0].first) > 2800000) then
